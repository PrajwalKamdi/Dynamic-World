      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a
            ...
            className=" bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition duration-200 hover:-translate-y-1"
          >
            <svg 
              className="w-5 h-5" 
              fill="currentColor" 
          ...
          <a
            ...
            className="border-2 border-white text-white hover:bg-white hover:text-blue-600 px-4 py-2 rounded-lg flex items-center space-x-2 transition duration-200 hover:-translate-y-1"
          >
            <svg 
              className="w-5 h-5" 
              fill="currentColor" 
